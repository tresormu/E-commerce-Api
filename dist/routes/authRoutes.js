...
router.post("/register", cloudinary_middleware_1.upload.single("image"), authController_1.register);
...
router.put("/profile", authMiddleware_1.protect, cloudinary_middleware_1.upload.single("profile"), authController_1.updateUser);
